            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="favori.php"><i class="fa fa-heart"></i> <span id="countfavori"><?= $favori->count() ?></span></a></li>
                            <li><a href="panier.php"><i class="fa fa-shopping-bag"></i> <span id="countpanier"><?= $panier->count() ?></span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span id="totalpanier"><?= number_format($panier->total(),2,',',' '); ?></span></div>
                    </div>
                </div>
            </div>
