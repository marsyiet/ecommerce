<?php
  ...
  try{
    ...
    $requete1 = connect()->prepare("SELECT * FROM livreurs WHERE id= ?"); 
   ...
   if (isset($_POST['modifier'])){
      ...
      if(empty($login)){ 
        ...
        $requete = connect()->prepare("UPDATE livreurs SET  nom = :nom, mail = :mail, ville = :ville, quartier = :quartier WHERE id = :id1");
  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title text-center">modifier un livreur</h4>
