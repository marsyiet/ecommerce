<?php
  ...
  try{
    ...
    $requete1 = connect()->prepare("SELECT * FROM paiements WHERE id= ?"); 
   ...
   if (isset($_POST['modifier'])){
      ...
      if(empty($libelle)){ 
        ...
        $requete = connect()->prepare("UPDATE paiements SET  libelle = :libelle WHERE id = :id1");
  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title text-center">modifier une méthode de paiement</h4>
              <form class="forms-sample" action="modifier.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="login" class="form-control" id="nom"  value="<?php foreach($reponse as $rep){echo $rep['libelle'];} ?>" name="libelle">
                </div>
