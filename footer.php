            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: Yaounde</li>
                            <li>Phone: +692801450</li>
                            <li>Email: etoundimarius237@gmail.com</li>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer__widget">
                        ...
                        <p>Recevoir des emails sur nos dernieres offres</p>
                        <form action="#">
                            <input type="text" placeholder="Entez votre adresse mail">
